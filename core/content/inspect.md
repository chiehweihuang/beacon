...
<!--/@cc-->
<!--@codex-->
If the user opted in during Step 1, save anonymized aggregate data to a local private stats file (one JSON line per audit). This data contains NO source code, file paths, or project names:
<!--/@codex-->
