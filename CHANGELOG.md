...
- deterministic detector measurement harness + seed corpus (8912347)
- externalise advisor detectors into a declarative pattern library (v1.0 data-only) (fcd135f)
- quarantine LLM judgment out of the machine score (P8) (a6c6d84)
- stamp engine_fingerprint for reproducibility (P3) (277350c)
- static-audit.mjs becomes sole author of audit-results.json (P1) (a1d8cab)
- keyboard focus-flow + multi-state auditing (2.1.2/2.4.3/2.4.7/2.4.11/2.1.1) (2c1f2c7)
- heuristic content-quality red-flags (alt / link purpose / label) (6b66cfd)
- WCAG 3.1.2 Language of Parts (unmarked foreign passages) (7066acb)
- PDF-generation accessibility parity with the Claude hook (8299fbb)
- batch site-PDF accessibility triage CLI (757ff30)
- source-level 3.3.8 barriers (JS-set password + clipboard block, JS/GTM-injected CAPTCHA) (8afdaad)
- PDF accessibility probe (WCAG 1.3.1/2.4.2/3.1.1/4.1.2 + PDF/UA) (b1954ab)
- PDF accessibility — hook coverage for PDF generation, guide section for document output (3e38c72)
- Tier-2 wiring so lang/auth detectors cover SPAs + sync generated outputs (9b7e53a)
- flag WCAG 3.3.8 authentication barriers (0ff425d)
- flag declared-lang vs content-language mismatch (WCAG 3.1.1) (9b31e48)

### Bug Fixes

- catalog-aware secondary-marker resolution — 11 FP -> 0 (e98dc2a)
- auth-hcaptcha word boundary + pdf encryption suppression (P5 follow-up) (d6e3375)
- annotate intentional inspect duplicate lines (dc5118b)
- read unquoted <html lang=..> (codex follow-up) (172e666)
- address independent codex review findings (3.1.1 / 3.3.8) (5d20b56)

### Documentation

- complete 2.2.0 entries (fed0342)
- publish auth-detect + pdf-detect false-positive tables (P5) (26ae4ab)
- add OCRmyPDF to PDF tools (OCR text-layer remediation for scanned PDFs) (88be68d)
- precise axe PDF description, add veraPDF to tools (1fe024b)

### Tests

- held-out validation for 3.1.1 language + 3.3.8 auth detectors (42b60eb)
- held-out corpus for 4 regex-ceiling detectors (1efa277)

### CI

- add GitHub Actions workflow (node --test + build --check + detector measurement) (12f7adf)

### Chores

- reset version to 2.1.0 for the engine to bump; date changelog (7759edc)
- ignore tooling scratch (playwright-mcp, firecrawl, root scratch) (2dd84d6)
- add .release.json for the shared /release engine (8fc3cf9)

### Other

- clean cool-slate palette + fix muddy score-ring color (b4001be)
