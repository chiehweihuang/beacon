...
ใช้คะแนนเป็นสัญญาณสำหรับจัดลำดับความสำคัญ (triage signal):

| ช่วงคะแนน | ความหมาย |
|---|---|
| 90-100 | Baseline อัตโนมัติดูแข็งแรง ยังควรตรวจ keyboard, screen reader, zoom, และ real-user สำหรับ flow ที่สำคัญ |
